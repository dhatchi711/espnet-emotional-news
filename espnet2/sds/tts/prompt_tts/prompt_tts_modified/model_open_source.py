...
from espnet2.sds.tts.prompt_tts.prompt_tts_modified.modules.alignment import (
    AlignmentModule,
    GaussianUpsampling,
    average_by_duration,
    viterbi_decode,
)
from espnet2.sds.tts.prompt_tts.prompt_tts_modified.modules.encoder import Encoder
from espnet2.sds.tts.prompt_tts.prompt_tts_modified.modules.initialize import initialize
from espnet2.sds.tts.prompt_tts.prompt_tts_modified.modules.variance import (
    DurationPredictor,
    VariancePredictor,
)
